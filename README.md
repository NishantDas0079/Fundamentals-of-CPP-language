```mermaid
quadrantChart
    title C++ Concepts Difficulty vs Importance
    x-axis "Easy to Learn" --> "Challenging"
    y-axis "Fundamental" --> "Advanced"
    
    "Hello World": [0.1, 0.9]
    "Variables": [0.2, 0.8]
    "Data Types": [0.3, 0.85]
    "Input/Output": [0.25, 0.75]
    "if-else": [0.4, 0.7]
    "Loops": [0.5, 0.65]
    "Pointers": [0.8, 0.6]
    "References": [0.7, 0.55]
    "new/delete": [0.75, 0.5]
    "Classes": [0.6, 0.45]
    "Inheritance": [0.65, 0.4]
    "Polymorphism": [0.85, 0.35]
    "File Handling": [0.55, 0.3]
    "Exception Handling": [0.6, 0.25]
```
